package test.java.io.mosip.print.test.service.impl;
...
import test.java.io.mosip.print.test.TestBootApplication;
...
public class PrintServiceTest {
	...
	public void setUp() throws Exception {
		...
		File printTextFile = new File(classLoader.getResource("test/resources/printTextFileJson.json").getFile());
		File mappingFile = new File(classLoader.getResource("test/resources/RegistrationProcessorIdentity.json").getFile());
		File credentialFile = new File(classLoader.getResource("test/resources/credential.json").getFile());

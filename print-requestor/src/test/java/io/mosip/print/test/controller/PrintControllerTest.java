...
import io.mosip.print.controller.PrintRequestController;
...
public class PrintControllerTest {
	...
	@InjectMocks
	private PrintRequestController printController;

	@Mock
	PrintRequestService printService;
	...
	public void testHandleSubscribeEventSuccess() throws Exception {
		...
		Mockito.when(printService.createRequest(Mockito.any())).thenReturn(true);
